...
init -989 python:
    if store.mas_submod_utils.isSubmodInstalled("Submod Updater Plugin"):
        store.sup_utils.SubmodUpdater(
            submod="Fictional Others & Fictional Crushes",
            user_name="TheAutumnApple",
            repository_name="MAS-Submods-FictionalOthers"
        )
    ...
    if ev.shown_count == 0:
        ...
        menu:
            ...
            "Have you perhaps ever heard of the term 'fictional other'?":
                m 1rtd "Hmm... {w=0.2} Now that you mentioned... {w=0.3}{nw}"
                ...
                m 2dup "With that aside... {w=0.2} About fictional crushes and fictional others... {w=0.2}"
                ...
                m 6dksdra "In the end, there's nothing bad about it as long as it doesn't develop into obsession, just like... {w=0.2} basically anything!"
                m 7kub "The best way is always the golden mean!"
                m 1hublu "... {w=0.2}"
                m 1fublu "... {w=0.2}"
                m 1etsdlc "... {w=0.2}"
                m 1eksdld "[player]... {w=0.2}"
                ...
                menu:
                    ...
                    "Yes...":
                        ...
                        m 5ekbld "Listen... {w=0.3} I want you to be comfortable opening up to me!"
                        ...
                        menu:
                            ...
                            "Only one... And it's you [m_name]!":
                                ...
                                m 1fsbfu "But I still I love you... {w=0.2} I'm sure that was just a minor miscommunication."
                            ...
                            "Actually... It's just one...":
                                ...
                                m 1tfbld "Unless it's none of the other girls of our Literature Club... {w=0.2} Then I might get a little jealous... {w=0.2}"
                                m 1tfbsu "... {w=0.2}"
                            ...
                            "A bunch... But you are my only REAL one!":
                                ...
                                m 4dkbfb "Actually, I think it's amazing the courage you just showed me by deciding to be open with me about this... {w=0.2}"
                                ...
                                m 1dkbfu "I love you [mas_get_player_nickname()]... {w=0.2} Never forget that..."
    else:
        m 2eksdlc "What's wrong [mas_get_player_nickname()]?{nw}"
        $ _history_list.pop()
        menu:
