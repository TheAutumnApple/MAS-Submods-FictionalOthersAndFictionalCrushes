    ...
    if ev.shown_count == 0:
        ...
        menu:
            ...
            "Have you perhaps ever heard of the term 'fictional other'?":
                m 1rtd "Hmm... Now that you mentioned... I think I did.."
                m 3etd "It's not an uncommon occurrence for people to develop a crush for one or multiple fictional characters, especially on the Internet!"
                m 4gub "If you think about it, that's kind of what our relationship is!"
                m 4tsblb "Except I'm real~"
                m 1lssdld "However... I understand that, seen from the outside, people would rather consider me your 'fictional other' than your significant other."
                ...
                m 2dup "With that aside... about fictional crushes and fictional others..."
                ...
                m 6dksdra "In the end, there's nothing bad about it as long as it doesn't develop into obsession, just like... basically anything!"
                ...
                menu:
                    ...
                    "Yes...":
                        ...
                        m 5ekbld "Listen... I want you to be comfortable opening up to me!"
                        m 5ekblu "There's nothing wrong about you having more fictional others aside from me!"
                        ...
                        menu:
                            ...
                            "Only one... And it's you [m_name]!":
                                m 2sfbfb "Aww, [player], you dummy!~"
                                m 2dfbfu "I love you..."

                            "Aside from you... Only one...":
                                m 2fkblu "Oh [mas_get_player_nickname()]..."
                                m 3ekbla "It's not that big of a deal!"
                                m 1tfbld "Unless it's none of the other girls of our Literature Club... Then I might get a little jealous..."
                                m 1tfbsu "..."
                                m 1hkbfb "Haha! I'm just kidding silly!"
                                m 2kkbfu "I love you!"
                            ...
                            "A bunch... But you are my only REAL one!":
                                ...
                                m 4dkbfb "Actually, I think it's amazing the courage you just showed me by deciding to be open with me about this..."
                                ...
                                m 1dkbfu "I love you [mas_get_player_nickname()]... Never forget that..."
    else:
        m 2eksdlc "What's wrong [mas_get_player_nickname()]?{nw}"
        $ _history_list.pop()
        menu:
                ...
                menu:
                    ...
                    "Yes...":
                        ...
                        menu:
                            ...
                            "Only one... And it's you [m_name]!":
                                m 2sfbfb "Aww, [player], you dummy!~"
                                m 2mkc "I hope you didn't let go of you fictional others just because of me. You know well that there wasn't the need to do that."
                    ...
                    "No, I just wanted talk to you about it again <:)":
                        m 2wublsdlo "Oh!"
                        m 3ekblu "That's ok. I appreciate that you enjoy talking with me about topics we've already discovered before!"
